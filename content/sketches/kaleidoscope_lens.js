...
function preload() {
  kaleidoscope = readShader('/sketches/shaders/kaleidoscope.frag', { varyings: Tree.texcoords2 });
  angelus = loadImage('/sketches/shaders/paintings/p15.jpg');
  lens = readShader('/sketches/shaders/lens.frag', { varyings: Tree.texcoords2 });
}
